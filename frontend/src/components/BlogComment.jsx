...
export default function BlogComment({comment , onLike , onEdit , onDelete}) {
    ...
    const handleSave = async () => {
        try {
            const res = await fetch(`/backend/blog-comments/editblogcomment/${comment._id}`, {
            method: 'PUT',
            headers: {
        ...
        <div className='flex-1'>
          ...
          <>
            ...
            <div className='flex items-center pt-2 text-xs border-t dark:border-gray-600 max-w-fit gap-2'>
              ...
              {currentUser &&
                (currentUser._id === comment.userId || currentUser.isUserAdmin) && (
                  <>
                    <button
                      type='button'
                      onClick={handleEdit}
